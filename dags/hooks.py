...
dag = DAG('hook', description="Exemplo de hook",
...
select_data_task = PythonOperator(
    ...
    python_callable=select_data, provide_context=True, dag=dag)

print_data_task = PythonOperator(
    task_id='print_data_task', 
    python_callable=print_data, provide_context=True,dag=dag)
