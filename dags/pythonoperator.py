...
dag = DAG('pythonoperator', description="Exemplo de pythonoperator",
          schedule_interval=None, start_date=datetime(2023,3,5),catchup=False)



def data_cleaner():
    dataset = pd.read_csv("/opt/airflow/data/Churn.csv",";")
    ...
    dataset.to_csv("/opt/airflow/data/Churn_Clean.csv",";", index=False)
